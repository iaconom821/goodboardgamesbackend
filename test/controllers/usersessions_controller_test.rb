...
class UsersessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usersession" do
    assert_difference('Usersession.count') do
      post usersessions_url, params: { usersession: { date: @usersession.date, session_id: @usersession.session_id, user_id: @usersession.user_id } }, as: :json
    end
  ...
  test "should update usersession" do
    patch usersession_url(@usersession), params: { usersession: { date: @usersession.date, session_id: @usersession.session_id, user_id: @usersession.user_id } }, as: :json
    assert_response 200
  end
